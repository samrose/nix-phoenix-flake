{
  description = "Example Nix Flake for Phoenix Framework";
  ...
  in {
    ...
    devShell = forAllSystems (system: let
      ...
      basePackages = with pkgs; [alejandra bat beam.packages.erlangR26.elixir_1_16 docker-compose entr gnumake overmind jq mix2nix (postgresql_16.withPackages (p: [p.postgis])) graphviz imagemagick inotify-tools python3 unixtools.netstat];
      hooks = ''
        source .env
